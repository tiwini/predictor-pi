"""Renderiza tutorial.md → tutorial.html (print-styled) → tutorial.pdf.

Usa el venv del weather-predictor (tiene markdown_it + weasyprint instalados):
    /home/popeye/weather-predictor/venv/bin/python _build_tutorial_pdf.py
"""
...
strong { color: #111; }
blockquote { border-left: 3px solid #f9a825; margin: .6em 0; padding: .2em .8em;
             color: #555; background: #fffdf4; }
...
<title>Crypto Predictor — Tutorial</title>
